define([
    ...
    login.bindListeners = function () {
        var $grid = $('.gadget .grid'),
            $searchText = $('.gadget .gadget-controls .search .text'),
            $controls = $('.gadget .gadget-controls');
        ...
        $controls.on('click', '.search .clear', function (e) {
            $('.gadget .gadget-controls .search .text').val('').focus();
            login.renderGrid();
        });
    };
    ...
    login.renderLayout = function () {
        ...
        login.$controls = $('.gadget-controls');
    ...
    login.renderGrid = function (data) {
        var $grid = $('.grid'),
            searchParts = $('.gadget-controls .search .text').val().toLowerCase().split(' ');
