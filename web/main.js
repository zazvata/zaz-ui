...
require.config({
    ...
    paths: {
        ...
        'rotateClass': 'vendor/jquery.rotateClass/jquery.rotateClass',
        ...
        'ElementQueries': 'vendor/resize-sensor/ElementQueries',
        'jsonTree': 'vendor/json-tree/json-tree'
    },
    shim: {
        'barCode': {
            deps: ['jquery']
