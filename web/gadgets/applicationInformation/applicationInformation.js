define([
    'framework/framework',
    'css!gadgets/applicationInformation/applicationInformation'
], function (
    framework
) {
    return $.widget('zaz.applicationInformation', framework.baseGadget, {
        ...
        _renderLayout: function () {
            ...
            var strTemplate = HBS['gadgets/applicationInformation/applicationInformation']();
        ...
        _loadData: function () {
            ...
            framework.serviceManager.exec({
                service: 'applicationInformation.get.data',
                success: success,
                error: error
            });
        },
